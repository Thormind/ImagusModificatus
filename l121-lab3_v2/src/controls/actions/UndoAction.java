...
/**
 * Action associated with the undo button of the main window.
 * Listens to the button and asks the command manager to execute an undo action
 * when it is pressed.
 * @author Frederic Belanger
 * @version 1.0
 * @since 1.0
 */
public class UndoAction extends Action implements ActionListener
{
	public UndoAction() {
		super(AvailableCommands.UNDO);
	}

	/**
	 * Callback for when an undo action is performed.
